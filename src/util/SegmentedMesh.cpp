...
namespace ark {
    ...
    void SegmentedMesh::Setup(SLAMSystem& slam, CameraSetup* camera) {
    ...
    Eigen::Vector3i SegmentedMesh::LocateBlock(const Eigen::Vector3d &point)
    {
    ...
    SegmentedMesh::MeshUnit::MeshUnit()
    {
