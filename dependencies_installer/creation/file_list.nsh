  ...
  MessageBox MB_OK "$INSTDIR\DBoW2"
  
  MessageBox MB_OK "$INSTDIR\DLib"
  
  MessageBox MB_OK "$INSTDIR\DLoopDetector"
  ...
  MessageBox MB_OK "$INSTDIR\Open3D"
  
  MessageBox MB_OK "$INSTDIR\opencv343-contrib"
