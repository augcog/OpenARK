...
void rgb_pose_estimation() {
	...
	std::string protoFile = "C:\\dev\\openpose\\models\\pose\\mpi\\pose_deploy_linevec_faster_4_stages.prototxt";
	std::string weightsFile = "C:\\dev\\openpose\\models\\pose\\mpi\\pose_iter_160000.caffemodel";
...
int main(int argc, char ** argv) {
    ...
    const std::string IMG_PATH = "C:\\dev\\OpenARK_dataset\\human-basic2-D435\\capture_11.yml";
    ...
    if (planes.size()) {
        ...
        auto humanCloud = boost::make_shared<pcl::PointCloud<pcl::PointXYZ>>();
		...
		voxel_processor.setLeafSize(0.05f, 0.05f, 0.05f);
        ...
        viewer->addPointCloud(humanCloud_down, DATA_CLOUD_NAME, 0);
        //ava.fit(humanCloud);
